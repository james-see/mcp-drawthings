...
// Register tools
server.tool("check_status", checkStatusDescription, checkStatusSchema.shape, async () => {
...
server.tool("transform_image", transformImageDescription, transformImageSchema.shape, async (params) => {
